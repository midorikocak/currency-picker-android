...
public class ExtendedCurrency {
    public static final ExtendedCurrency[] CURRENCIES = {
            ...
            new ExtendedCurrency("ILS", "Israel Shekel","S", R.drawable.flag_ils),
            ...
            new ExtendedCurrency("LKR", "Sri Lanka Rupee","Rs", R.drawable.flag_lkr),
            ...
            new ExtendedCurrency("MUR", "Mauritius Rupee","Rs", R.drawable.flag_mur),
            ...
            new ExtendedCurrency("NPR", "Nepal Rupee","Rs", R.drawable.flag_npr),
            new ExtendedCurrency("NZD", "New Zealand Dollar","$", R.drawable.flag_nzd),
            new ExtendedCurrency("OMR", "Oman Rial","Or", R.drawable.flag_omr),
            ...
            new ExtendedCurrency("PKR", "Pakistan Rupee","Rs", R.drawable.flag_pkr),
            new ExtendedCurrency("PLN", "Poland Zloty","zl", R.drawable.flag_pln),
            new ExtendedCurrency("PYG", "Paraguay Guarani","Gs", R.drawable.flag_pyg),
            new ExtendedCurrency("QAR", "Qatar Riyal","R", R.drawable.flag_qar),
            ...
            new ExtendedCurrency("VND", "Viet Nam Dong","D", R.drawable.flag_vnd),
            new ExtendedCurrency("YER", "Yemen Rial","R", R.drawable.flag_yer),
            new ExtendedCurrency("ZAR", "South Africa Rand","R", R.drawable.flag_zar),
            new ExtendedCurrency("AOA", "Angolan Kwanza","Kz", R.drawable.flag_ang)
    };
    private String code;
    private String name;
